...
class item_similarity_recommender_py():
    ...
    def construct_cooccurence_matrix(self, user_songs, all_songs):
        ...
        for i in range(0,len(all_songs)):
            ...
            for j in range(0,len(user_songs)):       
                ...
                #Get unique listeners of (item) j
                users_j = user_songs_users[j]
                    
                #intersection of listeners of artists i and j
                users_intersection = users_i.intersection(users_j)
                
                #cooccurence_matrix[i,j] as Jaccard Index
    ...
    def generate_top_recommendations(self, user, cooccurence_matrix, all_songs, user_songs):
        ...
        #Sort the indices of user_sim_scores
        #maintaining the corresponding score
        sort_index = sorted(((e,i) for i,e in enumerate(list(user_sim_scores))), reverse=True)
    
        #Create a dataframe from the following
        columns = ['user_id', 'ARTIST', 'score', 'rank']
    ...
    def recommend(self, user):
        ...
        #Get all unique items  in the training data
